...
export function ConnectionsManager({
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      if ((activeProvider === "github" || activeProvider === "gmail" || activeProvider === "google_calendar") && !editing) {
  ...
  function reconnect(connection: Connection) {
    if (connection.provider !== "github" && connection.provider !== "gmail" && connection.provider !== "google_calendar") return openEdit(connection);
